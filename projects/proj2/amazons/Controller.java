...
final class Controller {
    ...
    void play() {
        ...
        while (_playing) {
            ...
            String command;
            if (_winner == BLACK) {
                this.reportNote("Black wins.");
            }
            if (_winner == WHITE) {
                this.reportNote("White wins.");
            }
            if (_winner == null) {
    ...
    private Command[] _commands = {
        ...
        new Command("auto\\s+black", this::doAutob),
        new Command("auto\\s+white", this::doAutow),
        new Command("manual\\s+black", this::doManualb),
        new Command("manual\\s+white", this::doManualw),
        new Command(MOVE_PATTERN.pattern(), this::doMove),
