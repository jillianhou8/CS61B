...
public class Tester extends Homework0 {
    ...
    public void maxTest() {
        ...
        assertEquals(14, forMax(new int[] { 2, 3, 4, 5, 6 }));
        assertEquals(14, forMax(new int[] { 7, -3, 12, 16, 98 }));
    ...
    public void threeSumTest() {
        ...
        assertTrue(threeSum(new int[] { 5, 3, 1, 2, 6}));
        // REPLACE THIS WITH MORE TESTS.
    }
    ...
    public void threeSumDistinctTest() {
        ...
        assertFalse(threeSumDistinct(new int[] { 8, 2, -1, -1, 15 }));
