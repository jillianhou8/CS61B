...
public class CompoundInterest {
    ...
    static double totalSavings(double perYear, int targetYear, double rate) {
        double amt = perYear;
        int num = numYears(targetYear);
        while (num != 0) {
            amt += perYear * Math.pow((1 + rate/100), num);
            num--;
        }
        return amt;
    }
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        return nominalSavings * Math.pow((1 - inflationRate/100), numYears(targetYear));
    }
    ...
    static void printSavingsFV(int targetYear, double returnRate,
        ...
        double nominalSavings = futureValue(10000, returnRate, targetYear); // replace 0 with your code
        double realSavings = futureValueReal(10000, returnRate, targetYear, inflationRate);    // replace 0 with your code
        // Do not change anything in this method below this line
